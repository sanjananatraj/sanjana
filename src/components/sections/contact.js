...
const Contact = ({ pageRefs }) => {
   ...
   return (
      <section className={styles.contact} id="#contact" ref={el => pageRefs.current = { ...pageRefs.current, contact: el}}>
         ...
         <p>I&apos;m currently open to new opportunities in software engineering. I'm based in the Bay Area, but I'm willing to relocate/work remotely. You can either <a href="mailto:sanjananatraj319@gmail.com">send me an email</a> or use the
